...
public class SwiftProgressHUD {
    ...
    /// Success
    @discardableResult
    public class func showSuccess(_ text: String, autoClear: Bool = true, autoClearTime: Int = 2) -> UIWindow? {
        if let _ = UIApplication.shared.keyWindow {
    ...
    /// Fail
    @discardableResult
    public class func showFail(_ text: String, autoClear: Bool = true, autoClearTime: Int = 2) -> UIWindow? {
        if let _ = UIApplication.shared.keyWindow {
